...
// We emit events on `destroy` object on each 'inner-window-destroyed'
// notification with an innerWinID event type.
const destroy = {};
observers.add("inner-window-destroyed", function(subject, topic, data) {
  let id = subject.QueryInterface(Ci.nsISupportsPRUint64).data;
  emit(destroy, subject.QueryInterface(Ci.nsISupportsPRUint64).data);
});
